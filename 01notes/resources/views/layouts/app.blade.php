...
<head>
    ...
    <title>Laravel 13 Note List APP</title>
    <!-- @yield('styles') -->
    ...
    <style type="text/tailwindcss">
        .btn {
            @apply rounded-md px-2 py-1 font-medium text-slate-500 shadow-sm text-center ring-1 ring-slate-700/10 hover:bg-slate-50
        }
